...
class CreateStateDocumentTable extends Migration {
	...
	public function up()
	{
		Schema::create('state_document', function(Blueprint $table)
		{
			$table->integer('document_number')->primary();
			$table->string('state_code', 2)->nullable();
			$table->string('state_name', 2)->nullable()->comment('This is the name of the state the document is from');
			$table->string('document_type        ', 45)->nullable();
			$table->string('document_name', 250)->nullable()->comment('This field contais the nmae of the docuument');
